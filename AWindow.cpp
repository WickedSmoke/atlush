...
void AWindow::createTools()
{
    ...
    _packAlgo = new QComboBox;
    _packAlgo->addItem("BinPack");
    _packAlgo->addItem("BinPack Sort");
    _packAlgo->addItem("SkyLine");
    _packAlgo->addItem("SkyLine BF");
